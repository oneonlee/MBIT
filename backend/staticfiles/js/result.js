...
function sendLink() {
    ...
    Kakao.Link.sendDefault({
        ...
        content: {
            ...
            imageUrl: 'https://mbittest-cxhnu.run.goorm.io/static/img/mbit_thumbnail.png',
            link: {
                mobileWebUrl: 'https://mbittest-cxhnu.run.goorm.io',
                webUrl: 'https://mbittest-cxhnu.run.goorm.io',
            },
        },
        social: {
            likeCount: 286,
